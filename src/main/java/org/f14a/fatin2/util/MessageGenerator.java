...
public class MessageGenerator {
    ...
    public static class MessageBuilder {
         ...
         * Adds a message segment with the specified type and data.
         * @param type the segment type
         * @param data a JsonElement representing the segment data
         * @return this builder instance for method chaining
         */
        ...
        /**
         * Construct a text message, equals to <code>segment("text").data("text", text).end()</code>
        ...
        /**
         * Construct an at message, equals to <code>segment("at").data("qq", text).end()</code>
         * @param userId the text content
         * @return this builder instance for method chaining
         */
        ...
        /**
         * Construct a face message, equals to <code>segment("face").data("id", faceId).end()</code>
         * @param faces the enum of face
         * @return this builder instance for method chaining
         */
        ...
        /**
         * Construct a reply message, equals to <code>segment("reply").data("id", messageId).end()</code>
         * <p>
         * Put this segment at the beginning of the message.
        ...
        /**
         * Construct an image, equals to <code>segment("image").data("file", file).end()</code>
         * @param file the url or path of the image file
         *             e.g. "http://...", "file://...", "base64://..."
         * @return this builder instance for method chaining
         */
        ...
        /**
         * Construct a file, equals to <code>segment("reply").data("file", file).data("name", name).end()</code>
         * @param file the url or path of the image file
         *             e.g. "http://...", "file://...", "base64://..."
         * @return this builder instance for method chaining
         */
        ...
        /**
         * Construct a forward node, accepts a complete node JsonObject generated by NodeGenerator
         * @param node the node JsonObject
         * @return this builder instance for method chaining
         */
